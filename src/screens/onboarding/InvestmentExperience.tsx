...
function InvestmentExperience({
  navigation,
}: StackScreenProps<OnboardingStackParamList, ScreenNames.InvestmentExperience>) {
  ...
  const currentQuestion = useMemo(
    ...
    () => questionnaire.find((question) => question.name === INVESTMENT_QUESTION_TYPE.LEVEL)!,
    [questionnaire],
  );
  ...
  const handleNext = useCallback(async () => {
    ...
    navigation.navigate(ScreenNames.InvestmentGoal);
...
export default memo(InvestmentExperience);
