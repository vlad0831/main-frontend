...
function RoundUpsAndRecurring({
  navigation,
}: StackScreenProps<MainStackParamList, ScreenNames.RoundUpsAndRecurring>) {
  ...
  const [initialTransaction] = useState(() => initialTransactions[9]);
...
export default memo(RoundUpsAndRecurring);
